...
{	
    public function view($request, $route, $link){
        ...
        $listItems = $currentItem->testSpin()
                                ->act()
                                ->get();
        $dataTestSpin = TestSpin::buildDataSpinCate($currentItem,$listActiveTestSpinToday);
        return view('test_spin_categories.view',compact('currentItem','listItems','listItemTestSpinCategory','listActiveTestSpinToday','dataTestSpin'));
    }
}