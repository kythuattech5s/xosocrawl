    ...
    (function (a, b) {
        ...
        function q(a) {
            ...
            if (window.getSelection) {
                if (
                    ((b = window.getSelection()), b.getRangeAt && b.rangeCount)
                ) {
        ...
        function E() {
            ...
            if (
                !b.sprite &&
                b.lasyEmoji[0] &&
                b.lasyEmoji.eq(0).is(".lazy-emoji")
            ) {
                ...
                O = G(
                    ...
                    (r = b.picker =
                        G(
                            ...
                            .addClass(
                                F("picker-position-" + d.pickerPosition, !0)
                            )
                            .addClass(
                                F("filters-position-" + d.filtersPosition, !0)
                            )
                            .addClass(
                                F("search-position-" + d.searchPosition, !0)
                            )
                            .addClass("hidden"))
                );
                ...
                b
                    ...
                    .on("@!paste", function (c, d) {
                        ...
                        if (d.originalEvent.clipboardData) {
                            var f =
                                d.originalEvent.clipboardData.getData(
                                    "text/plain"
                                );
                            return (
                                e(f),
                ...
                var S = function () {
                        ...
                        f.sort(),
                            ...
                            d.textcomplete.placement &&
                                "static" ==
                                    a(
                                        i.data("textComplete").option.appendTo
                                    ).css("position") &&
        ...
        function N(b) {
            ...
            g(function () {
                ...
                b.useInternalCDN &&
                    ...
                    (e.imagePathSVGSprites =
                        M.base + "/sprites/emojione.sprites.svg"),
                    (e.imageType = b.imageType)),
                    u(c) > 4
                        ? ((z = e.regUnicode),
                          (e.imageType = b.imageType || "png"))
                        : (z = new RegExp(
