...
$subValue = @$subValue && is_array(@$subValue) ? $subValue : [];
...
<div class="elementor_json_field">
	...
	<textarea class="control hidden" data-name="<?php echo $name; ?>" name="<?php echo $name; ?>" id="<?php echo $key . $name; ?>" data-type="ELEMENTOR_JSON_FIELD.VIEW"><?php echo json_encode($subValue) ?? ''; ?></textarea>
