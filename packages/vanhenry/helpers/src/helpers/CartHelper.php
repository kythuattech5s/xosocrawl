...
class CartHelper {
	...
	public static function getInstance(){
		if(static::$_cart ==null){
			static::$_cart = new self;
		}
		return static::$_cart;
	}
	...
	protected function _save_cart()
	{
		...
		Session::put(array('cart_contents' => $this->_cart_contents));
		// Woot!
		return TRUE;
	}
	// --------------------------------------------------------------------
	...
	public function removeByField($field,$vfield)
	{
		foreach ($this->_cart_contents as $key => $item) {
			if($item[$field] == $vfield){
