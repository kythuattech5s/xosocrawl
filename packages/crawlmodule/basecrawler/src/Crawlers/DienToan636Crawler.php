...
class DienToan636Crawler extends BaseCrawler
{
    protected $imageSaveDir = 'old/dien-toan-636';
    protected $crawlLink = 'https://xoso.me/kq-xsdt-6-36-ket-qua-xo-so-dien-toan-6-36-truc-tiep-hom-nay.html';
    protected $nextlLink = 'https://xoso.me/kq-xsdt-6-36-ket-qua-xo-so-dien-toan-6-36-truc-tiep-hom-nay/%s.html';
    ...
    public function crawlItems($listItems)
    {
        ...
        foreach ($listItems as $item) {
            ...
            $oldItem = DienToan636::where('fullcode',$itemAdd->fullCode)->first();
            if (isset($oldItem)) {
                continue;
            }
            $itemAdd->act = 1;
