...
<div class="box box-customer">
    ...
    <div class=" txt-center pad10">
        <a href="login-social/google" class="login-button login-gg magb10" style="display: inline-block">
            <span class="solid">
    ...
    <form id="login-form" class="form-horizontal form-validate" action="dang-nhap" method="post" accept-charset="utf8" absolute accept-charset="utf8" data-success="AUTH_GUI.registerDone">
        ...
        <div class="txt-center">
            ...
            <a class="btn password-reset-link underline" href="quen-mat-khau" title="Quên mật khẩu">Quên mật khẩu</a>
        </div>
    </form>
    <div class="pad10"></div>
    <div class="social-title pad10">* Không đăng nhập được qua Google hoặc không có mật khẩu đăng nhập, bấm <a class="clnote bold underline" href="quen-mat-khau" title="Lấy lại mật khẩu">vào đây</a></div>
</div>
@endsection
@section('jsl')
