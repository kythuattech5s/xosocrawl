<?php $lottoRecordPrev = $lottoRecord->prev(false,true);$linkPrefix = null; ?>
@include('xoso.mien_bac.result_table_nearest',['lottoRecord'=>$lottoRecordPrev,'viewRelate'=>'related_news_1'])
<?php $lottoRecordPrevPrev = $lottoRecordPrev->prev(false,true);$linkPrefix = null; ?>
@include('xoso.mien_bac.result_table_nearest',['lottoRecord'=>$lottoRecordPrevPrev,'viewRelate'=>'related_news_2'])
<div id="box-result-more" lotto-record-id="{{$lottoRecord->id}}" lotto-type="dow"></div>
