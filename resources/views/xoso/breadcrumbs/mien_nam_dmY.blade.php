<h2 class="tit-mien clearfix">
    <strong>
        <a class="title-a" href="{{ $lottoCategory->slug }}"
            title="{{ $lottoCategory->short_name }}">{{ $lottoCategory->short_name }}</a>
        »
        <a class="title-a" href="{{ $lottoCategory->linkDayOfWeek($lottoRecord) }}"
        ...
        »
        <a class="title-a" href="{{ $lottoCategory->linkDate($lottoRecord) }}"
