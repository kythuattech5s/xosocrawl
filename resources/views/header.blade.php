...
@if (isset($bannerGdnHeader))
    <div class="txt-center ">
        <div class="center dspblockinline">
            @if ($bannerGdnHeader->use_code != 1)
                <a class="dspinlineblock ban-link" href="{{Support::show($bannerGdnHeader,'link')}}" {{$bannerGdnHeader->nofollow == 1 ? 'rel="nofollow"':''}} {{$bannerGdnHeader->is_blank == 1 ? ' target="_blank"':''}} title="{{Support::show($bannerGdnHeader,'name')}}">
